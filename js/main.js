...
let user1_gender = usersGender[0]
let user2_gender = usersGender[1]
let user3_gender = usersGender[2]
let user4_gender = usersGender[3]
let user5_gender = usersGender[4]
let user6_gender = usersGender[5]
let user7_gender = usersGender[6]
let user8_gender = usersGender[7]
let user9_gender = usersGender[8]
let user10_gender = usersGender[9]
let user11_gender = usersGender[10]

user1_gender.textContent = data[0].gender
user2_gender.textContent = data[1].gender
user3_gender.textContent = data[2].gender
user4_gender.textContent = data[3].gender
user5_gender.textContent = data[4].gender
user6_gender.textContent = data[5].gender
user7_gender.textContent = data[6].gender
user8_gender.textContent = data[7].gender
user9_gender.textContent = data[8].gender
user10_gender.textContent = data[9].gender
user11_gender.textContent = data[10].gender
